...
module.exports = msgHandler = async (client, message) => {
    try {
	    ...
	    const ttsJp = require('node-gtts')('ja')
            ...
            if (dataText.length > 500) return client.reply(from, 'Teks terlalu panjang njerrr!', id)
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6281368646011@c.us')
            break
        case '!ig':
	...
	case '!listsurah':
        ...
        case '!quotemaker':
            ...
            break
        case '!linkgroup':
            if (!isBotGroupAdmins) return client.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin makanya jadiin gw admin :v', id)
            if (isGroupMsg) {
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ Full Fitur BOT Broadcast ]\n\n${msg}`)
            }
        ...
        case '!kickall':
            ...
            if (!isBotGroupAdmins) return client.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin makanya jadiin gw admin', id)
        ...
        case '!promote':
            ...
            if (!isBotGroupAdmins) return client.reply(from, 'Fitur ini hanya bisa di gunakan ketika bot menjadi admin makanya jadiin gw admin', id)
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/6281368646011', id)
