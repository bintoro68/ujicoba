...
┷┯ ☾ Others Commands ☽
   ...
   ╿
   ╰╼❥ Kirim perintah *!readme* untuk mengetahui fungsi dan cara penggunaan perintah di atas, NO SPAM!!!.`
}
exports.help = help()
function readme() {
    return `
...
Contoh : *!tts id Test*
Note : Max 250 huruf jangan lebih ya
...
Contoh : *!quotemaker |GW BOT|Anker|Shark*
...
function info() {
    return `Bot di buat tanggal 17-11-2020
*Autor* = *ANKER PRODUCTION*
*IG*    = *anker_2412*
*KALO ADA BUG LAPOR GW YA*

Oh Ya Jangan Lupa Donasinya Awkwokwok:v.`
}
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *Whatsap Anker*
...
*SAWERIA*  : https://saweria.co/donate/anker_2412
